...
function contactFunction() {
  ...
  let cartona = `<div class="p-2">
    ...
    <div class="row pt-5 ">
        ...
        <div class="col-md-6">
            <div class="margin-input">
                ...
                <div class="alert alert-warning my-1 d-none" id="emailError">
        ...
        <div class="col-md-6">
            <div class="margin-input">
                ...
                <div class="alert alert-warning my-1 d-none" id="passwordError">
                    Please enter a valid password Minimum eight characters and at least one letter
                </div>
    ...
    <button class="btn btn-outline-info mt-4" id="finalBtn" disabled type="submit">Submit</button>
